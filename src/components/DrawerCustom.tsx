  ...
  return (
    <View style={{paddingTop: StatusBar.currentHeight, paddingHorizontal: 20}}>
      <View>
        ...
        <TextComponent text="Nguyễn Minh Tuấn" font={fontFamilies.medium} size={20} />
      </View>
      <FlatList
      ...
      />
      <ButtonComponent styles={{marginTop: 60, width: '70%', elevation:0}} textColor='#00F8FF' color='#F2FFFF' iconFlex='left' icon={<Crown size={size} color='#00F8FF'/>} type='primary' text='Upgrade Pro'/>
    </View>
  );
};
